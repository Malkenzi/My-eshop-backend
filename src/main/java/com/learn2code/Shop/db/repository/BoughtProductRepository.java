...
public class BoughtProductRepository {
    ...
    // pridanie noveho kupeneho produktu
    public void add(BoughtProduct boughtProduct) {
        ...
        jdbcTemplate.update // vzdy musi byt prvy parameter 'sql'
                (sql, boughtProduct.getProductId(), boughtProduct.getCustomerId(), boughtProduct.getQuantity(),
                        boughtProduct.getBoughtAt());

    }

    // vratenie vsetkych kupenych produktov
