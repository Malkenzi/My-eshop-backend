...
// Reprezentacia Databazovej entity 'BoughtProduct'
...
public class BoughtProduct {
    private int productId;  // foregin key
    private int customerId; // foregin key // dva kluce na zaklade ktorych viem indentifikovat nakup (kto,kolko,aky)
    private int quantity;
    private Timestamp boughtAt; // cas kupenia produktu
